...
export default defineConfig({
  ...
  build: {
    ...
    terserOptions: {
      ...
      mangle: {
        reserved: ['$', 'jQuery'] // Protect against mangling
      }
    }
  },
  server: {
